...
const ProductQuantity = (props: ProductQuantityProps) => {
  ...
  return (
    <div className="col-span-2 xl:col-span-1 flex items-center justify-center space-x-6 border border-black py-2 px-2 text-black text-sm xl:text-lg font-bold">
