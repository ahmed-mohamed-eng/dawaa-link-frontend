    ...
    <div className="w-full flex flex-col items-start justify-start space-y-10">
      ...
      <div className="w-full grid grid-cols-2 gap-4">
        <div className="w-full flex flex-col items-start justify-start space-y-4">
          ...
          <ul className="flex flex-col items-start justify-start space-y-2 list-disc ps-4">
            <li>Integer nec dui ut mauris ultricies elementum.</li>
            <li>Integer nec dui ut mauris ultricies elementum.</li>
            <li>Integer nec dui ut mauris ultricies elementum.</li>
            <li>Integer nec dui ut mauris ultricies elementum.</li>
            <li>Integer nec dui ut mauris ultricies elementum.</li>
        ...
        <div className="w-full flex flex-col items-start justify-start border">
          <div className="w-full flex items-start justify-start border">
            <p className="w-1/3 px-5 py-3 font-bold text-lg text-[#023E8A] bg-[#F0F2F5]">
              Range
            </p>
            <p className="w-2/3 px-5 ps-14 py-3 text-lg text-[#6F6F6F]">
              -199.99 to 199.99 C
            </p>
          </div>
